...
<body class="bg-gray-200 p-4">
      <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
        ...
        <div class="mb-6">
          <form action="/comment" method="POST" class="flex flex-col space-y-4">
            @csrf
            <input type="text" name="name" placeholder="Your name" class="py-3 px-4 bg-gray-100 rounded-lg">
            <textarea class="py-3 px-4 bg-gray-100 rounded-lg" name="post" placeholder="Your comment" id="" cols="5" rows="2"></textarea>
            <button class="w-28 py-4 px-8 bg-green-500 text-white rounded-lg">Add</button>
          </form>
        </div>
        <hr>
        <div class="mt-2">
          ...
          <div class="py-4 flex items-center border-b border-gray-300 py-3">
            <div class="flex-1 pr-8">
              ...
              <p class="text-gray-500">{{$comment->post}}</p>
            </div>
