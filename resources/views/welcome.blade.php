...
<body class="bg-gray-200 p-4">
      <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
        ...
        <h1 class="font-bold text-5xl text-center mb-8">Laravel comment app</h1>

        <div class="mb-6">
          <form action="/" method="POST" class="flex flex-col space-y-4">
            <input type="text" name="title" placeholder="to do list" class="py-3 px-4 bg-gray-100 rounded-lg">
            <textarea class="py-3 px-4 bg-gray-100 rounded-lg" name="description" placeholder="to do description" id="" cols="5" rows="2"></textarea>
